        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @endphp
                    <tr>
                        <td class="text-muted small">{{ $reservation->IdReservation }}</td>
                        <td>
                        ...
                        <td>
                            <div class="d-flex gap-1 align-items-center">
                                <!-- Changer statut -->
                                <form action="{{ route('admin.reservations.update', $reservation->IdReservation) }}" method="POST">
                                    @csrf @method('PUT')
                                ...
                                <!-- Supprimer -->
                                <form action="{{ route('admin.reservations.destroy', $reservation->IdReservation) }}"
                                      method="POST"
